...
import { getCurrentLocation } from '@/lib/mapsApi';
...
export const OnboardingModal: React.FC<OnboardingModalProps> = ({ user, onComplete }) => {
    ...
    const requestLocation = async () => {
        ...
        try {
            ...
            const reverse = await api.reverseGeocode(position.latitude, position.longitude).catch(() => null);
